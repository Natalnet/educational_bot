...
def run():
    ...
    @bot.tree.command(name="userinfo", description="Mostra informações do usuário informado.")
    ...
    @bot.tree.command(name="myuser", description="Mostra informações do seu usuário no servidor.")
